...
export const TRANSFER_WETH_DISCRIMINATOR = new Uint8Array([
  52, 2, 229, 73, 74, 104, 13, 191,
]);

export function getTransferWethDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TRANSFER_WETH_DISCRIMINATOR
  );
}

export type TransferWethInstruction<
...
export type TransferWethInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type TransferWethInstructionDataArgs = { amount: number | bigint };

export function getTransferWethInstructionDataEncoder(): FixedSizeEncoder<TransferWethInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['amount', getU64Encoder()],
    ]),
    (value) => ({ ...value, discriminator: TRANSFER_WETH_DISCRIMINATOR })
  );
}

export function getTransferWethInstructionDataDecoder(): FixedSizeDecoder<TransferWethInstructionData> {
...
export function getTransferWethInstructionDataCodec(): FixedSizeCodec<
  TransferWethInstructionDataArgs,
  TransferWethInstructionData
> {
  return combineCodec(
    getTransferWethInstructionDataEncoder(),
    getTransferWethInstructionDataDecoder()
  );
}

export type TransferWethAsyncInput<
...
> = {
  ...
  amount: TransferWethInstructionDataArgs['amount'];
};

export async function getTransferWethInstructionAsync<
  TAccountSigner extends string,
...
> {
  ...
  return Object.freeze({
    ...
    data: getTransferWethInstructionDataEncoder().encode(
      args as TransferWethInstructionDataArgs
    ),
    programAddress,
  } as TransferWethInstruction<
    TProgramAddress,
    TAccountSigner,
    TAccountTo,
    TAccountStorageAccount,
...
export function getTransferWethInstruction<
  TAccountSigner extends string,
  TAccountTo extends string,
  TAccountStorageAccount extends string,
  TAccountWsolMint extends string,
...
export type ParsedTransferWethInstruction<
  TProgram extends string = typeof WSOL_PROGRAM_ADDRESS,
...
> = {
  ...
  data: TransferWethInstructionData;
};

export function parseTransferWethInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedTransferWethInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getTransferWethInstructionDataDecoder().decode(instruction.data),
  };
}
